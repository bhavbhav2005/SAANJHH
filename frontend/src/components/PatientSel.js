  ...
  return (
    <div className="p-4 flex justify-center items-center min-h-screen">
      <div className="w-full max-w-md">
        <h2 className="mb-4 text-3xl font-extrabold text-dark text-center md:text-5xl lg:text-5xl pb-2">Upload Data</h2>
        <form onSubmit={handleSubmit} className="shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="flex items-center justify-between">
            <button type="submit" className="submit-button button-black">
              Submit
            </button>
          </div>
        </form>
